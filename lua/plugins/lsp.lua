				...
				["omnisharp"] = {
					...
					settings = {
						RoslynExtensionsOptions = {
							EnableDecompilationSupport = true, -- Peek into SimpleRockets2.dll logic
							EnableImportCompletion = true,
							AnalyzeOpenDocumentsOnly = false,
						},
						Sdk = {
							IncludeNetServerExecutable = true,
						},
					},
					-- This forces the LSP to anchor at the root where your 'lib' and '.sln' live
